...
Welcome to Neo4j release 1.9-SNAPSHOT, a high-performance graph database.
...
* [Getting Started](http://docs.neo4j.org/chunked/1.9-SNAPSHOT/introduction.html)
* [The Neo4j Manual (online)](http://docs.neo4j.org/chunked/1.9-SNAPSHOT/)
